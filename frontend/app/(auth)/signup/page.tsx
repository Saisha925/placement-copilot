...
export default function SignupPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#050505] relative overflow-hidden px-4">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-fuchsia-500/10 blur-[120px] rounded-full pointer-events-none"></div>
      <div className="absolute top-0 right-0 w-[400px] h-[400px] bg-sky-500/5 blur-[100px] rounded-full pointer-events-none"></div>
      ...
      >
        <div className="flex flex-col items-center mb-8">
          <div className="h-12 w-12 rounded-xl bg-gradient-to-br from-fuchsia-500 to-purple-600 flex items-center justify-center shadow-[0_0_30px_rgba(217,70,239,0.3)] mb-6">
            <Target className="h-6 w-6 text-white" />
          </div>
          <h1 className="text-3xl font-bold text-white tracking-tight text-center">Create Account</h1>
          <p className="text-zinc-400 mt-2 text-center text-sm">Start your placement journey today.</p>
        </div>
        ...
        <div className="glass-card p-8 border border-white/10 bg-black/40 backdrop-blur-xl rounded-2xl shadow-2xl relative overflow-hidden">
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-white/5 border border-white/10 rounded-xl py-3 pl-10 pr-4 text-[14px] text-white focus:outline-none focus:border-fuchsia-500/50 focus:bg-white/10 transition-all"
                  value={name}
          ...
          <div className="mt-8 text-center border-t border-white/5 pt-6 relative z-10">
            <p className="text-[13px] text-zinc-400">
              ...
              <Link href="/login" className="text-white font-semibold hover:text-fuchsia-400 transition-colors">
                Sign in
              </Link>
            </p>
          </div>
